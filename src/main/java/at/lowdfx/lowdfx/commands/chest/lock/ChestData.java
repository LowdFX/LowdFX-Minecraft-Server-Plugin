...
public class ChestData {
    ...
    public ChestData() {
        this.dataFile = new File(Lowdfx.PLUGIN.getDataFolder(), "chestdata.yml");
        try {
    ...
    public void addPlayerToWhitelist(@NotNull Location location, String player) {
        String path = "chests." + location.getBlockX() + "_" + location.getBlockY() + "_" + location.getBlockZ() + ".whitelist";
        List<String> whitelist = dataConfig.getStringList(path);
    ...
    public void removePlayerFromWhitelist(@NotNull Location location, String player) {
        String path = "chests." + location.getBlockX() + "_" + location.getBlockY() + "_" + location.getBlockZ() + ".whitelist";
        List<String> whitelist = dataConfig.getStringList(path);
